...
// Module
export * from './base-prototype.module';
...
export * from './pages/set-password/set-password.component';
export * from './pages/email-verification/email-verification.component';
